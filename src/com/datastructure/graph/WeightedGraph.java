...
// Dikstart Shoetest path algorithm;
	...
	public boolean hasCycle() {
		Set<Node> visited = new HashSet<WeightedGraph.Node>();
		for (var node : nodes.values()) {
...
//	Spanning tree
	public WeightedGraph getMiniumSapanningTree() {
	...
	public static void main(String[] args) {
		...
		graph.getMiniumSapanningTree().print();
